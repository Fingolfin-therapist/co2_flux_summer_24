function licordata = IMPORTLICOR(filename, dataLines)
%IMPORTFILE Import data from a text file
%  LICORDATA = IMPORTFILE(FILENAME) reads data from text file FILENAME
%  for the default selection.  Returns the data as a table.
%
%  LICORDATA = IMPORTFILE(FILE, DATALINES) reads data for the specified
%  row interval(s) of text file FILENAME. Specify DATALINES as a
%  positive scalar integer or a N-by-2 array of positive scalar integers
%  for dis-contiguous row intervals.
%
%  Example:
%  licordata = importfile("S:\lascheer\CO2_FLUX\Test 4 April 2024\licor_data.txt", [1, Inf]);
%
%  See also READTABLE.
%
% Auto-generated by MATLAB on 05-Apr-2024 09:39:38
